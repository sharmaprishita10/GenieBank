package com.example.authenticationServiceOfBank.exceptionHandler;
...
import com.example.authenticationServiceOfBank.controller.AuthController;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> handleBadCredentials(BadCredentialsException e) {
		...
		ApiResponse response = new ApiResponse("Invalid username or password", HttpStatus.UNAUTHORIZED.value());
