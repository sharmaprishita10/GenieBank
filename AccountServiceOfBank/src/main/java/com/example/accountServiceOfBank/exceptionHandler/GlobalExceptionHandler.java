package com.example.accountServiceOfBank.exceptionHandler;
...
import com.example.accountServiceOfBank.controller.AccountController;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse> handleNullPointer(NullPointerException e) {
    	...
    	logger.error("No Such Element Exception: {}", e);
        ApiResponse response = new ApiResponse("No account found.", HttpStatus.NOT_FOUND.value());
        return new ResponseEntity<ApiResponse>(response, HttpStatus.NOT_FOUND);
    }
